...
input handling (\href{../SRS/SRS.tex}{R-Inputs}), NCRF computation (\href{../SRS/SRS.tex}{R-Calculate}), and
output generation for downstream analysis (\href{../SRS/SRS.tex}{R-Output}). Each test area
...
\subsubsection{Input Handling and API Selection (\href{../SRS/SRS.tex}{R-Inputs})}
...
\textbf{Test Case Derivation:} \href{../SRS/SRS.tex}{R-Inputs} requires the system to accept $e(t)$ as input.
...
\subsubsection{NCRF Computation (\href{../SRS/SRS.tex}{R-Calculate})}
...
\textbf{Test Case Derivation:} \href{../SRS/SRS.tex}{R-Calculate} requires computation of source-level neural current estimates.
...
\textbf{Input:} Repeat the same NCRF run twice.
...
\textbf{How Test Will Be Performed:} Compare outputs from repeated runs using relative error or norm.

\end{enumerate}

\subsubsection{Output Generation and Downstream Use (\href{../SRS/SRS.tex}{R-Output})}
...
\textbf{Test Case Derivation:} \href{../SRS/SRS.tex}{R-Output} requires both outputs in a format suitable for downstream analysis.
...
\textbf{Test Case Derivation:} \href{../SRS/SRS.tex}{R-Output} requires interoperability with the existing pipeline.
...
\textbf{Output}/Result: Output matches the reference within an agreed tolerance (relative error or norm).
...
\midrule
\href{../SRS/SRS.tex}{R-Inputs}  & FR-INPUT-01, FR-API-02, FR-API-03 \\
\href{../SRS/SRS.tex}{R-Calculate} & FR-CALC-01, FR-CALC-02 \\
\href{../SRS/SRS.tex}{R-Output} & FR-OUT-01, FR-OUT-02 \\
