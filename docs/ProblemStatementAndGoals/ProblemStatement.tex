...
This project aims to integrate NCRFs into existing purely TRF-based pipeline, allowing spatial and temporal response properties to be estimated jointly rather than sequentially. 
...
\textbf{Outputs}
\begin{itemize}
    \item Spatial information, indicating where in the brain stimulus-related activity occurs.
    \item Temporal information, describing how neural responses evolve over time.
...
\begin{itemize}
    \item Provide an interactive user interface for this pipeline.
