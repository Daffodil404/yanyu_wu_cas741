...
\begin{itemize}
  ...
  \item[GS1:] Estimate source-level neuro-current responses using NCRF methodology.
  \item[GS2:] Format results to be compatible with existing pipeline outputs and analysis workflows.
