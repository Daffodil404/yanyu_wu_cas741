...
The user could be a researcher or graduate student works on neuro-science, who will provide time-series stimuli and related neuro data, including datasets organized using the Brain Imaging Data Structure (BIDS) format, and it has been represented by the circle in Fig 1. The rectangle represents the software system (NCRF pipeline) and the the arrow indicates the workflow of data.
