...
The system should be built based on the existing TRF experiment pipeline and the related NCRF modules of Eelbrain. This constraint is required to preserve compatibility with the current research workflow, reuse existing preprocessing and baseline TRF analysis components, and support direct comparison between the integrated NCRF results and prior pipeline outputs. The pipeline will therefore remain Python-based, and its interactive functions will remain available through Jupyter Notebook.
