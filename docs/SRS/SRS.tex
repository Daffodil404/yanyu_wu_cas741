...
For readers, this document follows a bottom-up approach: it first introduces the basic concepts, then provides the system introduction, and finally presents the goals and implementation principles for the project.
