...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The format of the
  initial input data. (e.g., MEG/EEG Data)
\item[\refstepcounter{acnum} \actheacnum \label{acLaunch}:] Launching method (e.g., terminal command)
\end{description}
...
\item[Services:]Coordinates execution of the NCRF/TRF workflow through
  ...
  availability, and estimator choice) and invokes model computation through
  \texttt{load\_trf(...)}. This layer isolates requirement-driven behaviour from core
...
\item[Services:] Accept 'boosting' and 'ncrf' two types of estimator and make it effective.
\item[Implemented By:] \progname{}
\item[Type of Module:] Library
\end{description}
...
\item[Services:] Compute the related TRF
...
\acref{acLaunch} & \mref{mEstimator}\\
\bottomrule
\end{tabular}
