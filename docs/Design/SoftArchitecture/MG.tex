...
\item[Services:]Coordinates execution of the NCRF/TRF workflow through
  ...
  availability, and TRF computation) while treating estimator selection as a
  policy decision handled in the Software Decision Module. This layer isolates
  requirement-driven behaviour from core numerical implementation details.
\item[Implemented By:] --
\end{description}
...
\subsection{Software Decision Module (\mref{mEstimator})}
